!function(t, e, n) {
        ...
        this.each = function(t, n, r) {
            if (null !== t)
                if (e && t.forEach === e)
                    ...
                    for (var o in t)
                        if (t.hasOwnProperty(o) && n.call(r, t[o], o, t) === {})
                            return
        }
        ,
    ...
    return t.prototype = {
        ...
        murmurhash3_32_gc: function(t, e) {
            ...
            s = 461845907,
            c = 0; r > c; )
                u = 255 & t.charCodeAt(c) | (255 & t.charCodeAt(++c)) << 8 | (255 & t.charCodeAt(++c)) << 16 | (255 & t.charCodeAt(++c)) << 24,
                ++c,
                ...
                i ^= u,
                i = i << 13 | i >>> 19,
                a = 5 * (65535 & i) + ((5 * (i >>> 16) & 65535) << 16) & 4294967295,
                i = (65535 & a) + 27492 + (((a >>> 16) + 58964 & 65535) << 16);
            switch (u = 0,
            n) {
            case 3:
